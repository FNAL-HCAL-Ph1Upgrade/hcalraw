...
pedestalRange =      xrange(1,      1001)
capIDpedestalRange = xrange(1001,   2601)
pedestalScanRange =  xrange(2601,   9001)
iQiScanRange =       xrange(9001,   9801)
gselScanRange =      xrange(9801,  11101)
phaseScanRange =     xrange(11101, 21101)
